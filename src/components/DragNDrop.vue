        ...
        <v-layout align-start justify-center>
          ...
          <v-flex xs4 class="elevation-1 pa-3 ma-2">
            <v-list two-line>
              ...
              <draggable v-model="items1" :options="{group:'people'}" style="min-height: 10px">
              ...
              <draggable v-model="items2" :options="{group:'people'}" style="min-height: 10px">
                ...
                <template v-for="item in items2">
                  <v-list-tile :key="item.id" avatar>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title ripple v-html="item.title"></v-list-tile-title>
                      <v-list-tile-sub-title v-html="item.subtitle"></v-list-tile-sub-title>
                    </v-list-tile-content>
      ...
      items1: [
        {
          ...
          title: "Brunch this life? Brunch this life? Brunch this life?",
          subtitle: "Subtitle1 1 Subtitle 1 Subtitle 1 "
        },
        {
          id: 2,
